...
const BOARD_TILE_CONFIGS = [
  ...
  { type: TileType.CHANCE, name: 'Khí Vận', shortName: 'KHÍ VẬN', position: 3, imageUrl: '/assets/tiles/chance-vertical.png' },
  {
    type: TileType.PROPERTY,
    name: 'Thành Cổ Loa',
    shortName: 'Cổ Loa',
  ...
  { type: TileType.TAX, name: 'Thuế thu nhập', shortName: 'THUẾ', position: 5, imageUrl: '/assets/tiles/tax.png' },
  {
    type: TileType.PROPERTY,
  ...
  { type: TileType.FORTUNE, name: 'Cơ Hội', shortName: 'CƠ HỘI', position: 8, imageUrl: '/assets/tiles/fortune-vertical.png' },
  {
    type: TileType.PROPERTY,
  ...
  { type: TileType.JAIL, name: 'Nhà tù Hỏa Lò / Thăm nuôi', shortName: 'NHÀ TÙ', position: 11, imageUrl: '/assets/tiles/jail.png' },
  {
    type: TileType.PROPERTY,
    name: 'Phố Ngọc Lâm',
    shortName: 'Ngọc Lâm',
  ...
  { type: TileType.TAX, name: 'Thuế bảo vệ môi trường', shortName: 'THUẾ MT', position: 16, imageUrl: '/assets/tiles/tax.png' },
  {
    type: TileType.PROPERTY,
    name: 'Ga Hà Nội',
    shortName: 'Ga Hà Nội',
  ...
  { type: TileType.CHANCE, name: 'Khí Vận', shortName: 'KHÍ VẬN', position: 19, imageUrl: '/assets/tiles/chance-horizontal.png' },
  {
    type: TileType.PROPERTY,
    name: 'Phố Xã Đàn',
    shortName: 'Xã Đàn',
  ...
  { type: TileType.REST, name: 'Công viên Thống Nhất', shortName: 'CÔNG VIÊN', position: 22, imageUrl: '/assets/tiles/rest.png' },
  {
    type: TileType.PROPERTY,
  ...
  { type: TileType.FORTUNE, name: 'Cơ Hội', shortName: 'CƠ HỘI', position: 24, imageUrl: '/assets/tiles/fortune-vertical.png' },
  {
    type: TileType.PROPERTY,
  ...
  { type: TileType.TAX, name: 'Thuế hạ tầng', shortName: 'THUẾ HT', position: 27, imageUrl: '/assets/tiles/tax.png' },
  {
    type: TileType.PROPERTY,
    name: 'Bến xe Mỹ Đình',
  ...
  { type: TileType.GO_TO_JAIL, name: 'Vào Nhà tù Hỏa Lò', shortName: 'VÀO TÙ', position: 33, imageUrl: '/assets/tiles/go_to_jail.png' },
  {
    type: TileType.PROPERTY,
    name: 'Phố Liễu Giai',
    shortName: 'Liễu Giai',
  ...
  { type: TileType.CHANCE, name: 'Khí Vận', shortName: 'KHÍ VẬN', position: 36, imageUrl: '/assets/tiles/chance-horizontal.png' },
  {
    type: TileType.PROPERTY,
  ...
  { type: TileType.FORTUNE, name: 'Cơ Hội', shortName: 'CƠ HỘI', position: 39, imageUrl: '/assets/tiles/fortune-horizontal.png' },
  {
    type: TileType.PROPERTY,
    name: 'Phố Tràng Tiền',
  ...
  { type: TileType.TAX, name: 'Thuế xa xỉ', shortName: 'THUẾ XA XỈ', position: 42, imageUrl: '/assets/tiles/luxury_tax.png' },
  {
    type: TileType.PROPERTY,
    name: 'Phố Hàng Đào',
    shortName: 'Hàng Đào',
